...
final List<Map<String, dynamic>> emergencyHotlines = [
  {
    "name": "Example 1 Station",
    "latitude": 14.565,
    "longitude": 121.072,
    "phoneNumbers": ["09123456789", "09876543210", "123"], // List of phone numbers
  },
    {
    "name": "Example 1 Station",
    "latitude": 14.548849,
    "longitude": 121.072495,
    "phoneNumbers": ["123"], // List of phone numbers
  },
...
class ButtonOneScreen extends StatefulWidget {
  @override
  _ButtonOneScreenState createState() => _ButtonOneScreenState();
}

class _ButtonOneScreenState extends State<ButtonOneScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Nearest Hotline (Fire)'),
      ),

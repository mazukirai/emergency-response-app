...
class ButtonFourScreen extends StatefulWidget {
  @override
  _ButtonFourScreenState createState() => _ButtonFourScreenState();
}

class _ButtonFourScreenState extends State<ButtonFourScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Nearest Hotline (Medical Assistance)'),
      ),

...
class ButtonTwoScreen extends StatefulWidget {
  @override
  _ButtonTwoScreenState createState() => _ButtonTwoScreenState();
}

class _ButtonTwoScreenState extends State<ButtonTwoScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Nearest Hotline (Earthquake)'),
      ),
